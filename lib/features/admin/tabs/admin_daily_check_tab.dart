                        ...
                        : () async {
                            ...
                            try {
                              ...
                              if (type == 'DAILY_PAYMENT') {
                                ...
                                await ref
                                    .read(
                                      dailyCheckPageNotifierProvider.notifier,
                                    )
                                    .loadInitial(
                                      txDay: td,
                                      search: _searchQuery.trim(),
            ...
            child: Builder(
              builder: (context) {
                ...
                final customerWalletSummaries = <String, _DailyWalletSummary>{
                  for (final customer in customers)
                    customer.customerId: _DailyWalletSummary(
                      totalWalletCount:
                          customerRowsById[customer.customerId]
                              ?.totalWalletCount ??
                          0,
                      savedWalletCount:
                          customerRowsById[customer.customerId]
                ...
                final notSavedWalletCount =
                    pageState.summary.pendingWalletCount;
                                    ...
                                    if (pageState.loadingMore)
                                      ...
                                      Center(
                                        child: TextButton(
                                          onPressed: () => ref
                                              .read(
                                                dailyCheckPageNotifierProvider
                                                    .notifier,
                                              )
                                              .loadMore(),
