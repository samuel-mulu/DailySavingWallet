...
class CustomerSettingsTab extends ConsumerStatefulWidget {
  const CustomerSettingsTab({super.key});

  @override
  ConsumerState<CustomerSettingsTab> createState() =>
      _CustomerSettingsTabState();
}

class _CustomerSettingsTabState extends ConsumerState<CustomerSettingsTab> {
