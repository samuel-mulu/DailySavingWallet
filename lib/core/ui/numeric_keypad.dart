  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: AppBrand.primary.withValues(alpha: 0.20),
        highlightColor: AppBrand.primary.withValues(alpha: 0.10),
        child: Container(
          width: 64,
          height: 64,
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Center(child: Icon(icon, size: 28, color: AppBrand.primary)),
        ),
      ),
    );
  }
